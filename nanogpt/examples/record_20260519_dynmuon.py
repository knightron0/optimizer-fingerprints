...
for trial_idx in range(num_trials):
   ...
   # Original record seed disabled for array control: random.seed(seed)
   # Original record seed disabled for array control: np.random.seed(seed)
   # Original record seed disabled for array control: torch.manual_seed(seed)
   # Original record seed disabled for array control: torch.cuda.manual_seed_all(seed)
