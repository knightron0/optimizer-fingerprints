...
Skylight-001 — rule-compliant variant of iter078 with diagnostics stripped so the
self-embedded source in the logfile is fully self-contained (Rule 4).
"""
